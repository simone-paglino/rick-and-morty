...
const Card: React.FC<
  Pick<CardProps, 'character'> & Partial<Omit<CardProps, 'character'>>
> = ({ character, location, origin, episodes }) => {
  ...
  const {
    ...
    residents: originResidents,
  } = origin ?? {}

  const handleToggleShowMoreInfo = (): void =>
    ...
    <div className="card">
      <div className="card__image-character">
        ...
        <div className="card__image-character__info">
          <IconMoreLess
            show={showMoreInfo}
            className="card__image-character__info__icon"
          ...
          {location ? (
            <>
              ...
              />
              <TitleAndText
                boldText="Location type:"
                standardText={locationType}
                className="mt--1"
              />
              <TitleAndText
                boldText="Dimension:"
                standardText={dimension}
                className="mt--1"
              />
              <TitleAndText
                boldText="N° of residents:"
                standardText={residents}
                className="mt--1"
              />
            </>
          ) : (
      ...
      <div
        className={`card__more-info collapse--${
          showMoreInfo ? 'open' : 'close'
        }`}
        ...
        <div>
          {origin ? (
            <>
              ...
              <TitleAndText
                boldText="Origin type:"
                standardText={originType}
                className="mt--1"
              />
              <TitleAndText
                boldText="Origin dimension:"
                standardText={originDimension}
                className="mt--1"
              />
              <TitleAndText
                boldText="Origin n° of residents:"
                standardText={originResidents}
                className="mt--1"
              />
            </>
          ) : (
